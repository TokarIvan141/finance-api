  ...
  components: {
    ...
    components: {
      ...
      responses: {
        BadRequestError: {
          description:
            'Некоректний запит (помилка валідації, невірні типи даних, порушення унікальності Prisma)',
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: { name: { type: 'string', example: 'Оренда квартири' } },
              },
            },
          },
        },
                  ...
                  content: {
                    'application/json': {
                      schema: {
                        type: 'object',
                        properties: {
                          amount: { type: 'number', example: 1600.0 },
                          date: {
                            type: 'string',
                            format: 'date-time',
            ...
            '/api/v1/categories/{id}/budget': {
              ...
              post: {
                ...
                requestBody: {
                  content: {
                    'application/json': {
                      schema: { type: 'object', properties: { amountLimit: { type: 'number' } } },
                    },
                  },
                },
                responses: {
